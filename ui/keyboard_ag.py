...
class Ui_ag(object):
	...
	# Create and place objects
        ...
        self.pushButton_8.clicked.connect(lambda: self.addChar(" ", OtherWindow))
    ...
    def retranslateUi(self, OtherWindow):
        ...
        OtherWindow.setWindowTitle("Eyetalk A-G")
        self.pushButton.setText("A")
        self.pushButton_2.setText("B")
        self.pushButton_3.setText("C")
        self.pushButton_4.setText("D")
        self.pushButton_5.setText("E")
        self.pushButton_6.setText("F")
        self.pushButton_7.setText("G")
        self.pushButton_8.setText("Space")
