...
class Ui_ghijkl(object):
    ...
    def setupUi(self, OtherWindow):
        ...
        border = QPointF(self.screen.x() * 0.109375, self.screen.y() * 0.05)
        ...
        self.pushButton_4.setGeometry(QRect(border.x(), self.screen.y() - border.y() - btnSizeCir.y(), btnSizeCir.x(), btnSizeCir.y()))
        self.pushButton_4.setStyleSheet(btnStyleCir)
        self.pushButton_4.setObjectName("pushButton_4")
        
        self.pushButton_5 = QtWidgets.QPushButton(OtherWindow)
        self.pushButton_5.setGeometry(QRect(border.x()*2 + btnSizeCir.x(), self.screen.y() - border.y() - btnSizeCir.y(), btnSizeCir.x(), btnSizeCir.y()))
        self.pushButton_5.setStyleSheet(btnStyleCir)
        self.pushButton_5.setObjectName("pushButton_5")
        
        self.pushButton_6 = QtWidgets.QPushButton(OtherWindow)
        self.pushButton_6.setGeometry(QRect(border.x()*3 + btnSizeCir.x()*2, self.screen.y() - border.y() - btnSizeCir.y(), btnSizeCir.x(), btnSizeCir.y()))
        ...
        self.pushButton_7.setGeometry(QRect(0, 0, btnSizeCor.x(), btnSizeCor.y()))
        self.pushButton_7.setStyleSheet(btnStyleCor)
        self.pushButton_7.clicked.connect(lambda: self.openWindow("main", OtherWindow))
    ...
    def retranslateUi(self, OtherWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "J"))
        self.pushButton_5.setText(_translate("MainWindow", "K"))
