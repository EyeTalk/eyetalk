...
class Ui_hn(object):
    ...
    def retranslateUi(self, OtherWindow):
        ...
        OtherWindow.setWindowTitle(_translate("MainWindow", "EyeTalk H-N"))
        self.pushButton.setText(_translate("MainWindow", "H"))
        self.pushButton_2.setText(_translate("MainWindow", "I"))
        self.pushButton_3.setText(_translate("MainWindow", "J"))
        self.pushButton_4.setText(_translate("MainWindow", "K"))
        self.pushButton_5.setText(_translate("MainWindow", "L"))
        self.pushButton_6.setText(_translate("MainWindow", "M"))
        self.pushButton_7.setText(_translate("MainWindow", "N"))
        self.pushButton_8.setText(_translate("MainWindow", "Backspace"))
