...
class Ui_ou(object):
	...
	# Create and place objects
        ...
        self.pushButton_8.clicked.connect(lambda: self.toggleCaps(OtherWindow))
    ...
    def retranslateUi(self, OtherWindow):
        ...
        OtherWindow.setWindowTitle(_translate("MainWindow", "EyeTalk O-U"))
        ...
        self.pushButton_6.setText(_translate("MainWindow", "T"))
        self.pushButton_7.setText(_translate("MainWindow", "U"))
        self.pushButton_8.setText(_translate("MainWindow", "Caps On"))
